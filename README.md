...
- Account info [response]([https://js.xrpl.org/interfaces/AccountInfoResponse.html](https://js.xrpl.org/interfaces/AccountInfoResponse.html?utm_source=workshop&utm_medium=jason-morgan-state-mar-23&utm_campaign=dev-advocacy&utm_term=xrpl-transactions-workshop&utm_content=xrpl-transactions-workshop))
